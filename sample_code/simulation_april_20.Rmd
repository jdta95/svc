...
for (i in 1:1000)
{
  ...
  svclm[i, 1] = mean(low_rank$w_samples[2000:3000, , 1])
  svclm[i, 2] = mean(low_rank$w_samples[2000:3000, , 2])
  svclm[i, 3] = mean(low_rank$w_samples[2000:3000, , 3])
  svclm[i, 4] = time_taken
}
```
