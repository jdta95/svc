...
Compared to \pkg{spBayes}, our method performs more efficiently and has lower bias and RMSE for spatial random effects $w_0$, but has higher bias and RMSE for other coefficients $w_1$ and $w_2$.
